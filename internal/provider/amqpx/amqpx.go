...
type (
	ChannelReader interface {
		Channel() (*Channel, error)
	}

	ChannelReaderCloser interface {
		ChannelReader
		Close() error
	}
)

// Connection amqpx.Connection wrapper
...
// Dial wrap amqpx.Dial, dial and get a reconnect connection
